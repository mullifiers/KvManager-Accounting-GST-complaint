(function ()
{
    ...
    angular
        .module('app.invoices')
        .controller('summaryEcommerceController', summaryEcommerceController);

    /** @ngInject */
    function summaryEcommerceController(summary)
    {
        var vm = this;
        ...
        vm.widget1 = vm.summary.widget1;
        vm.widget2 = vm.summary.widget2;
        vm.widget3 = vm.summary.widget3;
        vm.widget4 = vm.summary.widget4;
        vm.widget5 = {
            title       : vm.summary.widget5.title,
            mainChart   : {
                config : {
            ...
            ranges      : vm.summary.widget5.ranges,
            currentRange: '',
            changeRange : function (range)
            {
                 ...
                 */
                angular.forEach(vm.summary.widget5.mainChart, function (chartData, index)
                {
        ...
        // Widget 6
        vm.widget6 = {
            title       : vm.summary.widget6.title,
            mainChart   : {
                config : {
                    refreshDataOnly: true,
                    deepWatchData  : true
            ...
            footerLeft  : vm.summary.widget6.footerLeft,
            footerRight : vm.summary.widget6.footerRight,
            ranges      : vm.summary.widget6.ranges,
            currentRange: '',
            changeRange : function (range)
            {
                 ...
                 * you can simplify these greatly.
                 */
                angular.forEach(vm.summary.widget6.mainChart, function (data, index)
                {
        ...
        // Widget 7
        vm.widget7 = {
            title       : vm.summary.widget7.title,
            ranges      : vm.summary.widget7.ranges,
            customers   : vm.summary.widget7.customers,
            currentRange: 'T'
        };
