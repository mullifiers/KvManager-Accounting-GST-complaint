(function ()
{
    ...
    /** @ngInject */
    function AddProductsController($document,$http, $state,Categories,msApi,api)
    {
        var vm = this;
        ////alert('asdfasd');
        // Data
        vm.saveProduct=function() {
             api.ratelists.insert(vm.product,function(err){
                    console.log(err);
                    $state.go('app.invoices.products',{},{reload:'app.invoices.products'})
